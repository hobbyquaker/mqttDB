    ...
    query(id, payload) {
        if (payload === '') {
            ...
            if (reduce) {
                ...
                api.result = api.reduce(api.result);
                `;
            }
            ...
            if (!this.viewsEnv[id].context) {
                ...
                const Sandbox = {
                    ...
                    api: {
                         ...
                         * @description executes a provided function once for each document.
                         */
                     ...
                     */
                    emit: item => Sandbox.api.result.push(item)
                };
